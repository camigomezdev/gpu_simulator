...
class SimRunner:
    def __init__(self):
        ...
        self.gpu = GPU()
        self.gpu.global_memory = self.global_memory
        self.n = 0
    ...
    def load_data(self, array_a, array_b, n):
        ...
        for i in range(n):
            self.global_memory.write(i, array_a[i])
            self.global_memory.write(i + n, array_b[i])
    ...
    def run_kernel(self, program, grid_dim, block_dim):
        ...
        results = [self.global_memory.read(
    ...
    def print_stats(self, stats):
        ...
        print(f"Throughput: { stats["excecuted_instructions"] / stats["cycles"]}")
